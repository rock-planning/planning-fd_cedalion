...
public:
    ...
    int get_length();
    // TODO: Remove in favor of more fine-grained access to SearchNodeInfo?
    const SearchNodeInfo &get_info() {
        return info;
    }
    ...
    void open(int h, const SearchNode &parent_node, std::vector<const Operator *> &steps);
