...
void SearchProgress::print_statistics() const {
    ...
    cout << "Expanded " << (expanded_states - reopened_states) << " state(s)." << endl;
    cout << "Reopened " << reopened_states << " state(s)." << endl;
    cout << "Expanded with reopening " << expanded_states << " state(s)." << endl;
    ...
    if (lastjump_f_value >= 0) {
        cout << "Expanded until last jump: "
             << (lastjump_expanded_states - lastjump_reopened_states) << " state(s)." << endl;
        cout << "Reopened until last jump: "
             << lastjump_reopened_states << " state(s)." << endl;
        cout << "Expanded with reopening until last jump: "
